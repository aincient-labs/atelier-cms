...
#[Capability(
  ...
  context_definitions: [
    ...
    'layout_json' => new ContextDefinition(data_type: 'string', label: new TranslatableMarkup('Layout'), description: new TranslatableMarkup('A JSON object of header/footer layout settings to set, e.g. {"header":{"logo_position":"center","logo_size":"large","sticky":false,"nav_alignment":"center"},"footer":{"layout":"stacked","logo_size":"large","show_tagline":true}}. The setting keys + allowed values are listed in the system prompt. Omit settings you are not changing.'), required: FALSE),
...
final class PreviewChrome extends CapabilityBase implements ExecutableCapabilityInterface {
